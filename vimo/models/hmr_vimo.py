...
from vimo.utils.geometry import perspective_projection
from vimo.utils.geometry import rot6d_to_rotmat_hmr2 as rot6d_to_rotmat
from vimo.datasets.track_dataset import TrackDataset
...
class HMR_VIMO(nn.Module):
    def __init__(self, cfg=None, device='cpu', **kwargs):
        ...
        # SMPL
        self.smpl = SMPL(cfg.SMPL_DATA_PATH)      
